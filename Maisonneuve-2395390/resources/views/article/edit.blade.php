    ...
    <div class="container">
        ...
        <form action="{{ route('article.update', $article->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title_fr" id="title_fr" class="form-control" value="{{ $article->title_fr }}" >
            </div>
            
            <div class="form-group">
                <label for="content_fr">Contenu (français)</label>
                <textarea name="content_fr" id="content_fr" class="form-control" >{{ $article->content_fr }}</textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="content_en" id="content_en" class="form-control" >{{ $article->content_en }}</textarea>
            </div>
